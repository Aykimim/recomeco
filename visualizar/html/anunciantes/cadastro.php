...
<div class="mb-3">
  ...
  <div class="mb-3">
    ...
    <input type="text" name="biografia" required placeholder="biografia" id="biografia"  rows="3" required placeholder="E-mail" id="biografia">
  </div>
...
<div class="mb-3">
    ...
    <input type="text" name="telefone" required placeholder="telefone" id="telefone"  required placeholder="telefone" id="telefone">
  </div>
//////////////////
<div class="mb-3">
    <label for="servico" class="form-label">serviço:</label>
    <input type="text" name="servico" required placeholder="biografia" id="biografia"  rows="3" required placeholder="serviço" id="servico">
  </div>
...
<div id="senha" class="form-text"> Sua senha deve ter de 8 a 20 caracteres, conter letras e números e não deve conter espaços, caracteres especiais ou emoji. </div>
</div>
...
<input type="password" name="senhaconf" required placeholder="Confirmar Senha" id="senhaconf" class="form-control" aria-describedby="senha">
  ...
  <button type="submit" value="Cadastrar" name="cadastrar" id="cadastrar class="btn btn-primary btn btn-success">Cadastrar</button>
